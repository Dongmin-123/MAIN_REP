...
### 계층구조 설명
1.BSP: MCU 가 실행되는데 가장 필수적인 요소들의 설정을 담당한다. cpu클럭, 워치독, HAL 기본 설정 등을 담당한다(HAL 기본함수 추상화).  
...
### 각 기능별 예제 정리파일
->stm32cube->repository->stm32cube_fw_xxxxx->drivers->projects->예제 참고하여 작성해도 됨.
